...
<?php if ( !(gridnext_get_option('hide_tags_title')) ) { ?>
<div class="gridnext-page-header-outside">
<header class="gridnext-page-header">
<div class="gridnext-page-header-inside">
<?php the_archive_title( '<h1 class="page-title">', '</h1>' ); ?>
<?php if ( !(gridnext_get_option('hide_tags_description')) ) { ?><?php the_archive_description( '<div class="taxonomy-description">', '</div>' ); ?><?php } ?>
</div>
</header>
</div>
<?php } ?>
